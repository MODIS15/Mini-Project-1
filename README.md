# Mini-Project-1
Mini-Project 1 - Mobile and Distributed Systems
...
2.Datagram loss on Wifi.
3.Datagram loss on ethernet.
4.Datagram loss on the Internet (i.e., transmitting across multiple physical nets).
